...
if __name__ == "__main__":
    ...
    # Provided input: a=0, b=1, cin=0
    # a_p = inp_at(1*T, name='a_p')
    # a_n = inp_at(0*T,  name='a_n')
    # b_p = inp_at(0*T, name='b_p')
    # b_n = inp_at(1*T, name='b_n')
    # cin_p = inp_at(1*T, name='cin_p')
    # cin_n = inp_at(0*T, name='cin_n')
    ...
    # a_p = inp_at(*T_ap, name='a_p')
    # a_n = inp_at(*T_an,  name='a_n')
    # b_p = inp_at(*T_bp, name='b_p')
    # b_n = inp_at(*T_bn, name='b_n')
    # cin_p = inp_at(*T_cp, name='cin_p')
    # cin_n = inp_at(*T_cn, name='cin_n')
