...
w1 = pylse.inp_at(125, 175, 225, 325, name='w1')
w0 = pylse.inp_at(75, 175, 225, 275, 375, name='w0')
r1 = pylse.inp_at(75, 175, 225, 325, 375, name='r1')
r0 = pylse.inp_at(25, 75, 125, 175, 275, name='r0')
d1 = pylse.inp_at(75, 175, 225, 325, 375, name='d1')
d0 = pylse.inp_at(35, 75, 125, 175, 275, name='d0')
we = pylse.inp_at(25, 55, 175, 275, name='we')
